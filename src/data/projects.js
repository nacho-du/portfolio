export const PROJECTS = [
  {
    ...
    cards: [
      ...
      {
        title: "Key outcome",
        body: "Improved process reliability by diagnosing heating control behavior and reducing interruptions during melting.",
      },
    ],
    sections: [
      {
...

  {
    ...
    cards: [
      ...
      {
        title: "Key outcome",
        body: "Validated performance through testing and refined the design through troubleshooting and iteration.",
      },
    ],
    sections: [
      {
    ...
    gallery: [
      { src: "/projects/water-nozzle.jpg", alt: "Water nozzle prototype" },
    ],
  },
];
