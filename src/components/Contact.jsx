        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-950/40 p-6">
            <div className="flex flex-col gap-3 text-sm">
              <a className="hover:text-white text-zinc-300" href="mailto:you@example.com">
                you@example.com
              </a>
              <a className="hover:text-white text-zinc-300" href="https://github.com/yourusername">
                GitHub: yourusername
              </a>
              <a className="hover:text-white text-zinc-300" href="https://linkedin.com/in/yourhandle">
                LinkedIn: yourhandle
              </a>
            </div>
